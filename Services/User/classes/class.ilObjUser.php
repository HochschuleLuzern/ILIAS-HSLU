...
class ilObjUser extends ilObject
{
    ...
    * @param	string	$a_type			object type
    */
    public function addDesktopItem($a_item_id, $a_type, $a_par = "")
    {
    ...
    */
    public function setDesktopItemParameters($a_item_id, $a_type, $a_par)
    {
        global $DIC;
    ...
    * @param	string	$a_type			object type
    */
    public function dropDesktopItem($a_item_id, $a_type)
    {
    ...
    */
    public static function _removeItemFromDesktops($a_id)
    {
        global $DIC;
    ...
    */
     ...
     * @return
     */
    public static function preloadIsDesktopItem($a_usr_id, $a_item_ids)
    {
        global $DIC;
    ...
    * @param	string	$a_type			object type
    */
    public function isDesktopItem($a_item_id, $a_type)
    {
        return ilObjUser::_isDesktopItem($this->getId(), $a_item_id, $a_type);
    }

    public function getDesktopItems($a_types = "")
    {
    ...
    */
    public static function _lookupDesktopItems($user_id, $a_types = "")
    {
        global $DIC;
